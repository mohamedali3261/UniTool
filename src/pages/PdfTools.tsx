...
const tools = [
  {
    ...
    descAr: 'دمج عدة صور في ملف PDF واحد',
    descEn: 'Merge multiple images into a single PDF file',
  ...
  },
  {
    ...
    descAr: 'تحويل صفحات PDF إلى صور PNG',
    descEn: 'Convert PDF pages to PNG images',
  ...
  },
  {
    ...
    titleEn: 'PDF to Word',
    descAr: 'تحويل ملف PDF إلى مستند Word',
    descEn: 'Convert PDF files to Word documents',
  ...
  },
  {
    id: 'wordToPdf',
    icon: FileText,
    titleAr: 'Word إلى PDF',
    titleEn: 'Word to PDF',
    descAr: 'تحويل مستند Word إلى ملف PDF',
    descEn: 'Convert Word documents to PDF',
  ...
  },
  {
    ...
    descAr: 'ضغط ملفات PDF لتقليل الحجم',
    descEn: 'Compress PDF files to reduce size',
