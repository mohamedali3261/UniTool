...
export const desktopNavItems: NavItem[] = [
  { id: 'compressionTools', labelAr: 'أدوات الضغط', labelEn: 'Compress', icon: Zap },
  ...
  { id: 'imageTools', labelAr: 'أدوات الصور', labelEn: 'Images', icon: LayoutGrid },
...
export const mobileNavItems: MobileNavItem[] = [
  { id: 'compressionTools', labelAr: 'أدوات الضغط', labelEn: 'Compress', icon: Zap, color: 'from-indigo-600 to-indigo-500', activeBg: 'bg-indigo-600/20 ring-1 ring-indigo-500/30' },
  ...
  { id: 'imageTools', labelAr: 'أدوات الصور', labelEn: 'Images', icon: LayoutGrid, color: 'from-pink-600 to-rose-600', activeBg: 'bg-pink-600/20 ring-1 ring-pink-500/30' },
