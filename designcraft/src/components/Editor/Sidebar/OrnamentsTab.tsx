...
export const OrnamentsTab: React.FC<OrnamentsTabProps> = ({
  ...
  const ORNAMENT_COLORS = [
    { name: t.ornGold, hex: '#F59E0B' },
    { name: t.ornYellow, hex: '#EAB308' },
    { name: t.ornCyan, hex: '#38BDF8' },
    { name: t.ornBlue, hex: '#0284C7' },
    { name: t.ornEmerald, hex: '#10B981' },
    { name: t.ornPink, hex: '#EC4899' },
    { name: t.ornPurple, hex: '#8B5CF6' },
    { name: t.ornWhite, hex: '#FFFFFF' },
    { name: t.ornDark, hex: '#0F172A' }
  ];
  ...
  return (
    <div className="flex flex-col h-full space-y-3.5 overflow-hidden">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder={t.ornSearchPlaceholder}
          value={searchQuery}
